...
VALUES ('111.111.111-11', 10, 5, 8, 9),
       ('222.222.222-22', 5, 10, 4, 2),
       ('444.444.444-44', 20, 2, 10, 4),
       ('555.555.555-55', 8, 6, 5, 2),    
       ('564.502.640-39', 2, 10, 12, 1),
       ('134.644.470-65', 5, 1, 10, 5),
       ('002.408.890-02', 3, 20, 20, 2),
       ('102.279.040-44', 5, 10, 4, 3),
       ('877.610.080-43', 10, 20, 16, 1),
       ('883.600.480-61', 6, 9, 9, 1),
       ('655.670.770-84', 10, 10, 10, 0),
       ('472.336.560-53', 3, 3, 3, 5),
       ('161.632.250-07', 1, 1, 1, 2),
       ('620.227.270-88', 5, 5, 5, 0);
...
VALUES ('837.836.670-70', 'Carlos Oliveira', '(11) 99999-1111', '1992-08-20', 'carlos@example.com', 'Rua das Torcidas, 45'),
       ...
       ('941.433.820-91', 'Romulo Junio', '(32) 93333-2222', '1985-03-15', 'romulo@example.com', 'Praca da Liberdade, 1'),
...
VALUES   ('111.111.111-11', '2023-08-01', 'Atacante'),
  ...
  ('555.555.555-55', '2023-10-01', 'Goleiro'),
  ('134.644.470-65', '2023-10-01', 'Defensor'),
  ('002.408.890-02', '2023-10-01', 'Meio-Campo'),
  ('111.111.111-11', '2023-10-01', 'Atacante'),
  ('564.502.640-39', '2023-10-01', 'Defensor'),
  ('102.279.040-44', '2023-11-15', 'Goleiro'),
  ('877.610.080-43', '2023-11-15', 'Atacante'),
  ('883.600.480-61', '2023-11-15', 'Defensor'),
  ('655.670.770-84', '2023-11-15', 'Meio-Campo'),
  ('472.336.560-53', '2023-11-15', 'Goleiro'),
  ('161.632.250-07', '2023-11-15', 'Atacante'),
  ('555.555.555-55', '2023-12-01', 'Goleiro'),
  ('134.644.470-65', '2023-12-01', 'Defensor'),
  ('002.408.890-02', '2023-12-01', 'Meio-Campo'),
  ('111.111.111-11', '2023-12-01', 'Atacante'),
  ('564.502.640-39', '2023-12-01', 'Defensor'),
  ('002.408.890-02', '2023-09-30', 'Defensor'),
  ('102.279.040-44', '2023-09-30', 'Meio-Campo'),
  ('111.111.111-11', '2023-09-30', 'Atacante'),
  ('564.502.640-39', '2023-09-30', 'Defensor'),
  ('134.644.470-65', '2023-09-30', 'Meio-Campo'),
  ('134.644.470-65', '2023-05-10', 'Meio-Campo'),
  ('877.610.080-43', '2023-08-20', 'Atacante'),
  ('883.600.480-61', '2023-08-20', 'Defensor'),
  ('655.670.770-84', '2023-08-20', 'Meio-Campo'),
  ('472.336.560-53', '2023-08-20', 'Goleiro'),
  ('161.632.250-07', '2023-08-20', 'Atacante'),
  ('002.408.890-02', '2023-05-10', 'Meio-Campo'),
  ('111.111.111-11', '2023-05-10', 'Atacante'),
  ('564.502.640-39', '2023-05-10', 'Defensor'),
  ('102.279.040-44', '2023-05-10', 'Goleiro'),
  ('877.610.080-43', '2023-05-10', 'Atacante');
       
-- Insercao de mais gols em partidas
INSERT INTO FazGol (CPF, Data, Minuto)
VALUES
  -- Partida em '2023-08-01' 1
  ('444.444.444-44', '2023-08-01', 15),  
  -- Partida em '2023-09-15' 2
  ('111.111.111-11', '2023-09-15', 10),  
  ('222.222.222-22', '2023-09-15', 60),  
  -- Partida em '2023-06-01'3
  ('444.444.444-44', '2023-06-01', 80),  
  ('002.408.890-02', '2023-06-01', 45),  
  ('134.644.470-65', '2023-06-01', 90),  
  -- Partida em '2023-05-15'2
  ('111.111.111-11', '2023-05-15', 20),  
  ('111.111.111-11', '2023-05-15', 44),
  -- Partida em '2023-04-01'1
  ('555.555.555-55', '2023-04-01', 75),

  -- Partida em '2023-03-15'2
   ('111.111.111-11', '2023-03-15', 5),   
   ('134.644.470-65', '2023-03-15', 15), 

  -- Partida em '2023-02-01'1
  ('102.279.040-44', '2023-02-01', 65),  
  ...
  -- Partida em '2023-10-01'

  -- Partida em '2023-11-15'
  ('102.279.040-44', '2023-11-15', 10),
  ('161.632.250-07', '2023-11-15', 60),
  -- Partida em '2023-12-01'
  ('111.111.111-11', '2023-12-01', 35),
  ('564.502.640-39', '2023-12-01', 40),
  -- Partida em '2023-09-30'
  ('111.111.111-11', '2023-09-30', 25),
  -- Partida em '2023-08-20'
  ('134.644.470-65', '2023-08-20', 10),
  ('883.600.480-61', '2023-08-20', 20),
  ('161.632.250-07', '2023-08-20', 50),
  -- Partida em '2023-05-10'
  ('877.610.080-43', '2023-05-10', 45);
